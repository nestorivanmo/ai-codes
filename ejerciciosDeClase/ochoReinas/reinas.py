...
def resolver(estado,nivel):
	...
	if nivel==8:	#Si se llega al nivel 8 significa que llego a una respuesta
...
def generarHijos(estado):	#Función para generar hijos
	...
	for i in range(8): #indica en que columna se encuentra

		for j in range(8):#indica en que posición de la columna se encuentra
	...
	for i in range(8):	#Va a ir moviendo a la nueva reina en la columna
